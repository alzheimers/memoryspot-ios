...
open class TimelineView: UIView {
     ...
     */
    open var detailLabelColor: UIColor = UIColor.white{
        didSet{
            setupContent()
        }
    }
    ...
    func blockForTimeFrame(_ element: TimeFrame, imageTag: Int) -> UIView{
        let v = UIView()
        v.translatesAutoresizingMaskIntoConstraints = false
        ...
        v.addConstraints([
            NSLayoutConstraint(item: button, attribute: .top, relatedBy: .equal, toItem: v, attribute: .top, multiplier: 1.0, constant: 0),
            NSLayoutConstraint(item: button, attribute: .bottom, relatedBy: .equal, toItem: v, attribute: .bottom, multiplier: 1.0, constant: 0),
            NSLayoutConstraint(item: button, attribute: .left, relatedBy: .equal, toItem: v, attribute: .left, multiplier: 1.0, constant: 0),
            NSLayoutConstraint(item: button, attribute: .right, relatedBy: .equal, toItem: v, attribute: .right, multiplier: 1.0, constant: 0)
            ])
    ...
    func buttonPress(button: UIButton){
        //delegate.handleSegueDelegate(button: button)
        delegate.handleSegueDelegate(button: button)
    }
}
